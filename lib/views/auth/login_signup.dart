...
import 'package:sahara_ems/controller/auth_controller.dart';
import 'package:sahara_ems/views/profile/add_profile.dart';
            ...
            child: Column(
              children: [
                ...
                isSignUp
                  ...
                  child: myText(
                    text:
                    'Welcome, Please Signup to get eventing',
                  ...
                  child: myText(
                    text:
                    'Welcome back, Please Signin to get eventing ',
                    style: GoogleFonts.roboto(
                      letterSpacing: 0,
                      fontSize: 18,
                      fontWeight: FontWeight.w400,
