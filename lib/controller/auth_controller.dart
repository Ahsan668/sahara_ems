...
class AuthController extends GetxController {
  ...
  void logout() {
    auth.signOut();
    Get.offAll(LoginView());  // Navigate to the login view after logging out
  }

  Future<bool> isInternetConnected() async {
    var connectivityResult = await (Connectivity().checkConnectivity());
    if (connectivityResult == ConnectivityResult.none) {
      Get.snackbar('Error', 'Internet Connection not working', colorText: Colors.white, backgroundColor: Colors.red);
      return false;
    }
    return true;
  }
